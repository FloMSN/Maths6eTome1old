...
\begin{center} \includegraphics[width=12cm]{carteNOES} \end{center}
...
\begin{tabularx}{\linewidth}{XX}
 ...
 Yawl & \includegraphics[width=1.3cm]{2X} \\
 Mayflower & \includegraphics[width=1.4cm]{4X} \\
 Titanic & \includegraphics[width=3.5cm]{5X} \\
 USS Gerald R.Ford & \includegraphics[width=3.5cm]{8X} \\
 \end{tabularx}
 \vspace{0.3cm}
