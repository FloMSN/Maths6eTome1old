...
%\begin{center} % un exemple de tableau donné par Simon en alternative
%\begin{tabularx}{.8\linewidth}{|c|*{6}{>{\centering \arraybackslash}X|}}
%\hline \rowcolor{FondTableaux} $x$ & 0 & $\pi/6$ & $\pi/4$ &$\pi/3$ & $\pi/2$ & $\pi$\\
%\hline \cellcolor{FondTableaux} $\cos x$ & $1$ & $\sqrt{3}/2$ &  $\sqrt{2}/2$ &$1/2$ & $0$ & $-1$ \\
%\hline \cellcolor{FondTableaux} $\sin x$ & $0$ & $1/2$ & $\sqrt{2}/2$ & $\sqrt{3}/2$ & $1$ & $0$ \\
%\hline
%\end{tabularx}
%\end{center}
